...
**Tests**: Tests are MANDATORY and written FIRST (TDD). Include unit, integration, and E2E tests aligned with acceptance criteria.
...
- [ ] T009 Setup environment configuration management
 - [ ] T010 Configure security headers (CSP, HSTS, X-Content-Type-Options, Referrer-Policy)
 - [ ] T011 Add CSRF protection for mutations and secure cookie settings
 - [ ] T012 Enable API rate limiting and basic abuse prevention
 - [ ] T013 Setup dependency scanning and vulnerability alerts in CI
